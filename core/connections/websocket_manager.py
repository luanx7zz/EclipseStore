...
class WebSocketManager:
    ...
    def set_bot(self, bot) -> None:
        """Registra a instância do bot para uso interno."""
        self.bot = bot
    ...
    def set_callbacks(
        ...
        """Registra callbacks de alto nível para eventos do WebSocket."""
    ...
    async def start(self) -> None:
        """Inicia o WebSocket (alias de initialize para compatibilidade)."""
