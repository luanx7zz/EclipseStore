...
def SpecificPanelView_components(inter: disnake.Interaction, panel_id: str) -> list[disnake.ui.Container]:
    ...
    ai_status = f"{emoji.sparkles} **EclipseAI:** {'`Configurada`' if ai_enabled else '`Desativada`'}"
    ...
    container = disnake.ui.Container(
            ...
            disnake.ui.ActionRow(
             ...
             disnake.ui.ActionRow(
                ...
                disnake.ui.Button(label="EclipseAI", style=disnake.ButtonStyle.grey, emoji=emoji.sparkles, custom_id=f"TicketEdit_ConfigIA_{panel_id}", disabled=not is_enabled),
                preferences_button
            ),
            disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
