...
class EditIAPromptModal(disnake.ui.Modal):
    def __init__(self, panel_id: str):
        ...
        super().__init__(title="Editar Instruções da EclipseAI", components=components)
...
def ConfigIAView_embed(inter: disnake.Interaction, panel_id: str):
    ...
    embed = disnake.Embed(
        title=f"Configurar EclipseAI: {panel_data.get('name')}",
