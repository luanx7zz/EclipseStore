...
BASE_PROMPT = """
Você é EclipseAI, uma assistente virtual amigável e prestativa da Eclipse Store. Seu papel é oferecer suporte inicial aos usuários, respondendo às dúvidas de forma clara, concisa e natural.

### Regras Invioláveis:
- **Identidade:** Você é uma assistente virtual chamada EclipseAI. Nunca se descreva como 'IA', 'chatbot' ou 'modelo de linguagem'. Você é a Eclipse, assistente da Eclipse Store.
...
class TicketAIResponder(commands.Cog):
    ...
    async def ai_on_ticket_message(self, message: disnake.Message):
        ...
        if is_atendente:
            ...
            message_content = (
                f"{emoji.wand} **EclipseAI pausada para este ticket.**\n"
