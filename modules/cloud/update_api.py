...
try:
    from core.connections import get_manager as _get_ws_manager
    from core.connections.websocket_manager import WebSocketManager as WSManager
except ImportError:
    try:
        from core.connections import get_manager as _get_ws_manager
        from core.connections.websocket_manager import WebSocketManager as WSManager
    ...
    try:
        ...
        try:
            ...
            return (
                ...
                or "SUA_URL_CLOUD_AQUI"
            )
        except Exception:
            return "SUA_URL_CLOUD_AQUI"
    ...
    async with aiohttp.ClientSession() as session:
        ...
        try:
            ...
            if not ws_manager.is_connected():
                return False, "Serviço de sincronização não disponível no momento. Configure e inicie o servidor de sincronização.", {}
