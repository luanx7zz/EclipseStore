...
def _get_automation_options():
        return [
                            ...
                            disnake.SelectOption(label="EclipseAI Chat", value="ia_chat", description="Tenha um chat com IA em seu servidor", emoji=emoji.double_speech),
                            disnake.SelectOption(label="EclipseAI Moderator", value="filtro_tos", description="Tenha um moderador com IA em seu servidor", emoji=emoji.sparkles),
                            ...
                            disnake.SelectOption(label="Autorole Avançado", value="autorole", description="Adicione e remova cargos automaticamente", emoji=emoji.double_check),
                            disnake.SelectOption(label="Sistema de Formulários", value="formularios", description="Crie formulários personalizados dentro do servidor", emoji=emoji.receipt),
                            disnake.SelectOption(label="Sistema de Parcerias", value="parcerias", description="Realize parcerias automáticas com servidores", emoji=emoji.partner),
                            disnake.SelectOption(label="Sistema de Gifts", value="gifts", description="Envie gifts automáticamente sobre requisitos", emoji=emoji.gift2),
                            disnake.SelectOption(label="Sistema de Instagram", value="instagram", description="Tenha um instagram dentro do servidor", emoji=emoji.heart2),
                            disnake.SelectOption(label="Sistema de Cartas", value="cartas", description="Sistema de cartas para os membros utilizarem", emoji=emoji.mail2),
    ...
    def PainelComponents() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                ...
                disnake.ui.TextDisplay("Gerencie as opções de automações do seu **Eclipse Bot**."),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
